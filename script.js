...
const portfolioProjects = [
  ...
  {
    title: 'Flyer · Paquete Impulso Redes',
    cardTitle: 'Paquete Impulso Redes',
    desc: 'Flyer publicitario para paquete de contenido en redes sociales. 5 posts, 2 videos y 2 historias animadas. Diseño con efecto de profundidad y mockups de celular.',
    cardDesc: 'Diseño para paquete de contenido digital. $399 pesos todo incluido.',
    cat: 'flyers',
    badge: 'Flyer',
    isNew: false,
    tags: ['Redes', 'Marketing'],
    lightboxTags: ['Canva', 'Redes Sociales', 'Publicidad'],
    img: 'https://i.ibb.co/S74bkzHR/Chat-GPT-Image-4-may-2026-07-05-21-p-m.png',
    type: 'image'
  },
  {
...
function openLightbox(id) {
  ...
  if (id === 'promo1') {
    content.innerHTML = `
      <img class="lb-img" src="${promo1Src}" alt="Paquete Impulso Redes" onerror="this.onerror=null;this.src='${IMG_FALLBACK}'">
...
// ---- PROMO TRACK LOOP (DESPLAZAMIENTO INFINITO) ----
...
// EDITAR: pon el link de cada captura en el src="" vacío de cada .testimonial-shot en index.html
...
if (testimonialsTrack) {
  ...
  testimonialsTrack.querySelectorAll('.testimonial-shot').forEach((shot, i) => {
    shot.addEventListener('click', () => openTestimonialImage(i % testimonialShotSrcs.length));
  });
}
